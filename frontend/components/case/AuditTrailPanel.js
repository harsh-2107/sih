...
const AUDIT_EVENTS = [
  {
    ...
    description: "SHA-256 verification run on all 6 evidence artifacts.",
    detail: "EVID-2024-001 through EVID-2024-006 — All hashes matched.",
    icon: CheckCircle2,
    color: "var(--success)",
  ...
  },
  {
    ...
    time: "11:15",
    type: "GRAPH UPDATED",
    description: "Investigation graph rebuilt after new evidence ingestion.",
    detail: "+4 entities, +7 relationships, +2 anomalies added to CASE-2049.",
    icon: Activity,
    color: "var(--primary)",
  ...
  },
  {
    ...
    time: "11:00",
    type: "EVIDENCE ADDED",
    description: "ANPR Camera Logs ingested and analysed.",
    detail: "EVID-2024-006 — Port Security Video Feeds. 45.0 MB.",
    icon: Upload,
    color: "var(--primary)",
    bg: "bg-[var(--primary)]/10 border-[var(--primary)]/20",
  },
  {
    ...
    description: "Graph anomaly detection run completed.",
    detail: "3 anomalies flagged — confidence range 72–94%.",
    icon: Activity,
    color: "var(--warning)",
  ...
  },
  {
    ...
    time: "16:35",
    type: "EVIDENCE ADDED",
    description: "Surveillance ANPR Telemetry uploaded.",
    detail: "EVID-2024-006 committed. Hash: 1a2b3c4d…",
    icon: Upload,
    color: "var(--primary)",
    bg: "bg-[var(--primary)]/10 border-[var(--primary)]/20",
  },
  {
    ...
    time: "22:15",
    type: "EVIDENCE ADDED",
    description: "Telecom CDR Call Data Records uploaded.",
    detail: "EVID-2024-004 — 28.4 MB. Hash: 7d8e9f0a…",
    icon: Upload,
    color: "var(--primary)",
    bg: "bg-[var(--primary)]/10 border-[var(--primary)]/20",
  },
